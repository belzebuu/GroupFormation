...
> M. Chiarandini, Z. Sun (2024). Team Formation with Diversity and Similarity
> Goals. Proceedings of PATAT 2024, Copenhagen.
> [[Paper](doc/patat2024_4532.pdf)].
...
The best is to use a virtual environment. Assuming it has been created with
`uv`, the following command activates it:
```bash
...
```bash
python3 src/prensio/main.py -h
```

Alternatively, you can change the DATA parameter in the Makefile for solving your own data set.
